...
function love.load()
    ...
    Admiral1Pic = love.graphics.newImage('res/characters/shark1.gif')
    Admiral2Pic = love.graphics.newImage('res/characters/shark2.gif')
    Admiral3Pic = love.graphics.newImage('res/characters/shark3.gif')
