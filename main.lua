...
function love.load()
    ...
    ShipShoot1Pic = love.graphics.newImage('res/ship/shoot1.gif')
    ShipShoot2Pic = love.graphics.newImage('res/ship/shoot2.gif')
    ShipShoot3Pic = love.graphics.newImage('res/ship/shoot3.gif')
